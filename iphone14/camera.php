...
<nav id="desktop-nav">
    ...
    <nav id="hamburger-nav">
      ...
      <div>
        ...
        <a href="\iphonediy/ip14.php" style="color:#777;">iPhone 14></a>
        <a href="#" style="color:black;"><b>iPhone 14 Camera</b></a>
      </div>
    ...
    <div class="container">
        ...
        <!-- <h1>iPhone 14 screen Replacement</h1>
        ...
        <div class="product-info">
            ...
            <p>Use this guide to replace a broken, cracked, or non‑responsive screen in your iPhone 14.</p>
        ...
        <!-- <section class="parts">
            ...
            <ul>
                <li>
                    <span class="part-name">iPhone 14 screen</span>
                    <span class="part-price">$29.99</span>
                </li>
                <li>
                    <span class="part-name">iPhone 14 screen Adhesive</span>
