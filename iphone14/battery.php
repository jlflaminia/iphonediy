...
?>
  ...
  <nav id="desktop-nav">
      ...
      <div>
        ...
        <a href="#" style="color:black;"><b>iPhone 14 Battery</b></a>
      </div>
      ...
      <div class="container">
          ...
          <div class="product-info">
              <h1>iPhone 14 Battery Replacement</h1><br>
              ...
              <p>The guide to replace the battery in your iPhone 14.</p>
          ...
          <!-- <section class="parts">
              ...
              <ul>
                  <li>
                      <span class="part-name">iPhone 14 Battery</span>
                      <span class="part-price">$29.99</span>
                  </li>
                  <li>
                      <span class="part-name">iPhone 14 Battery Adhesive</span>
