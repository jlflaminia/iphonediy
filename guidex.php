...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $device = "iPhone X"; // Device is fixed
    ...
    if ($stmt->execute()) {
        ...
        // header("Location: ipX.php?guide_id=" . $last_id);
        // exit();
    } else {
...
<?php if ($submitted): ?>
    <div class="success-message" style="text-align: center;">
        ...
        <a href="ipX.php" style="color: #333;">Back to Guides</a>
    </div>
<?php else: ?>
</div>
    <div class="guide-container">
        ...
        <section class="section">
            ...
            <div style="margin-bottom:10px;font-weight:600;">iPhone X</div>
            <input type="hidden" id="device" name="device" value="iPhone X">

            <label for="part">What part are you replacing?</label>
            <input type="text" id="part" name="part" placeholder="battery" required>

            <label for="title">Title</label>
            <input type="text" id="title" name="title" placeholder="iPhone X battery Replacement" required>
