...
$all_guides = [];
$guides_stmt = $conn->prepare("SELECT id, title, device, part, created_at FROM guides WHERE approved = 1 AND device = 'iPhone X' ORDER BY created_at DESC");
if ($guides_stmt) {
    $guides_stmt->execute();
...
<nav id="desktop-nav">
    ...
    <nav id="hamburger-nav">
      ...
      <div>
        ...
        <a href="#" style="color:black;"><b>iPhone X</b></a>
      </div>
    <section id="categories">
    <div class="container">
        <div class="product-image">
            <img src="./categories/ipx.png" alt="iPhone X">
        </div>
        <div class="product-info">
            <h1>iPhone X Repair</h1>
            <p>Repair and disassembly information for the iPhone X, released September 20th, 2024. It features a 6.1" OLED display, a 48 MP dual-camera system, and USB-C port.</p>
            <div class="actions">
                <button onclick="location.href='guidex.php'">Create a Guide</button>
            </div>
        </div>
    </div>
      <div class="main-details-container">
      <div class="about-containers ip-cat-grid">
        <a href="iphonex/battery.php" class="details-container color-container cat">
          <img src="./ip/battery.png" alt="Category 1" class="project-img"/>
          <p class="section__text__p1">Battery</p>
        </a>
        <a href="iphonex/screen.php" class="details-container color-container cat">
          <img src="./ip/screen.png" alt="Category 2" class="project-img"/>
          <p class="section__text__p1">Screen</p>
        </a>
        <a href="iphonex/camera.php" class="details-container color-container cat">
