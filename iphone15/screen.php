...
<nav id="desktop-nav">
    ...
    <nav id="hamburger-nav">
      ...
      <div>
        ...
        <a href="#" style="color:black;"><b>iPhone 15 Screen</b></a>
      </div>
    ...
    <div class="container">
        ...
        <div class="product-info">
            <h1>iPhone 15 Screen Replacement</h1>
            <div class="admin-image">
                <img src="\iphonediy/assets/jan.jpg" alt="ADMIN BONA">
                <div class="admin-details">
                    <p class="date"><b>Jan Michael Bona</b><br> Last updated on April 25, 2025</p>
                </div>
            </div>              
            <hr>
            <p> <b>Introduction</b></p>
            <p>Use this guide to replace a broken, cracked, or non‑responsive screen in your iPhone 15.</p>
