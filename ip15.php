...
$all_guides = [];
$guides_stmt = $conn->prepare("SELECT id, title, device, part, created_at FROM guides WHERE approved = 1 AND device = 'iPhone 15' ORDER BY created_at DESC");
if ($guides_stmt) {
    $guides_stmt->execute();
...
<nav id="desktop-nav">
    ...
    <nav id="hamburger-nav">
      ...
      <div>
        ...
        <a href="#" style="color:black;"><b>iPhone 15</b></a>
      </div>
    <section id="categories">
    <div class="container">
        <div class="product-image">
            <img src="./categories/ip15.png" alt="iPhone 16">
        </div>
      ...
      <div class="about-containers ip-cat-grid">
        <a href="iphone15/battery.php" class="details-container color-container cat">
          <img src="./ip/battery.png" alt="Category 1" class="project-img"/>
          <p class="section__text__p1">Battery</p>
        </a>
        <a href="iphone15/screen.php" class="details-container color-container cat">
          <img src="./ip/screen.png" alt="Category 2" class="project-img"/>
          <p class="section__text__p1">Screen</p>
        </a>
        <a href="iphone15/camera.php" class="details-container color-container cat">
