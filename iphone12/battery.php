...
?>
  ...
  <nav id="desktop-nav">
      ...
      <div>
        ...
        <a href="#" style="color:black;"><b>iPhone 12 Battery</b></a>
      </div>

      <section id="categories">          
          <!-- <a href="\iphonediy/ipiphone12\iphonediy/ipip12.php" style="color:#333;">&larr; Back to iPhone 12</a>     -->
      <div class="container">
          <div class="product-image">
              <img src="\iphonediy/ip/battery.png" alt="battery">
          </div>
          <!-- <h1>iPhone 12 Battery Replacement</h1>
          <p class="date">Last updated on April 23, 2025</p> -->
          <div class="product-info">
              <h1>iPhone 12 Battery Replacement</h1><br>
              ...
              <p>The guide to replace the battery in your iPhone 12.</p>
          ...
          <!-- <section class="parts">
              ...
              <ul>
                  <li>
                      <span class="part-name">iPhone 12 Battery</span>
                      <span class="part-price">$29.99</span>
                  </li>
                  <li>
                      <span class="part-name">iPhone 12 Battery Adhesive</span>
