...
<nav id="desktop-nav">
    ...
    <nav id="hamburger-nav">
      ...
      <div>
        ...
        <a href="#" style="color:black;"><b>iPhone 11 Camera</b></a>
      </div>
    ...
    <div class="container">
        ...
        <!-- <h1>iPhone 11 screen Replacement</h1>
        <p class="date">Last updated on April 23, 2025</p> -->

        <div class="product-info">
            <h1>iPhone 11 Screen Replacement</h1>
            <p> <b>Introduction</b></p>
            <p>Use this guide to replace a broken, cracked, or non‑responsive screen in your iPhone 11.</p>
        ...
        <!-- <section class="parts">
            ...
            <ul>
                <li>
                    <span class="part-name">iPhone 11 screen</span>
                    <span class="part-price">$29.99</span>
                </li>
                <li>
                    <span class="part-name">iPhone 11 screen Adhesive</span>
