...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $device = "iPhone 12"; // Device is fixed
    ...
    if ($stmt->execute()) {
        ...
        // header("Location: ip12.php?guide_id=" . $last_id);
        // exit();
    } else {
...
<?php if ($submitted): ?>
    <div class="success-message" style="text-align: center;">
        ...
        <a href="ip12.php" style="color: #333;">Back to Guides</a>
    </div>
<?php else: ?>
</div>
    <div class="guide-container">
        ...
        <section class="section">
            ...
            <div style="margin-bottom:10px;font-weight:600;">iPhone 12</div>
            <input type="hidden" id="device" name="device" value="iPhone 12">

            <label for="part">What part are you replacing?</label>
            <input type="text" id="part" name="part" placeholder="battery" required>

            <label for="title">Title</label>
            <input type="text" id="title" name="title" placeholder="iPhone 12 battery Replacement" required>
